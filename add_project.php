            ...
            <h1>Add New Project</h1> <br>
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="type" class="form-control" name="proj_name" required="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="proj_leader" class="form-control"  required="">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Project Task</label>
                        <input type="text" name="proj_task" class="form-control" required="">
                    </div>
                    <div class="mb-3">
