...
<body style="background-color: #004528;">
    ...
    <?php
		...
		$sql = "SELECT * FROM employee  where username='shagoto_t14' ;";
	...
	<div class="profile_info" style="text-align: center;">
		...
		<h4 style="color: white;"><?php echo 'a'; ?></h4>
	</div><br><br>
	<?php
	...
	<div class="form1">
		...
		<input class="form-control" type="text" name="Email" value="<?php echo $gmail; ?>">
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE `employee` SET   mobile_no='$mobile_no',dept_name='$dept_name' WHERE username='shagoto_t14' ;";
            echo $sql1;
